...
namespace lua.reader
{
    public class DataCache
    {
        ...
        public static void LoadAllData(List<string> enabledMods)
        {
            ...
            using (var lua = new Lua())
            {
                ...
                catch (Exception e)
                {
                    ...
                    ErrorLogging.LogLine($"Error loading dataloader.lua. This file is required to load any values from the prototypes. Message: '{e.Message}'");
                    return;
                }
        ...
        private static string AddLuaPackagePath(Lua lua, string dir)
        {
        ...
        private static void _AddLuaPackagePath(Lua lua, string dir)
        {
            try
            {
